...
<html lang="en">
<head>
    <title>Varyn Games | FAQ</title>
    <meta name="title" content="Varyn Games FAQ" />
...
<div id="page_container">
    ...
    <div id="top_promo">
        ...
        <p>Need help? Here are the answers to teh most common questions asked by our users.</p>
        <ul class="faq">
            <li>Do I need to Use Facebook to Login?</li>
            <li>I forgot my password, how do I get it?</li>
            <li>Can I Block Another User From Contacting Me?</li>
            <li>I Earned Coins, Where Are They?</li>
            <li>My Score Was On The Leaderboard, Why Is It No Longer There?</li>
            <li>There was a problem with a game I played! How do I report it?</li>
        </ul>
    </div>
