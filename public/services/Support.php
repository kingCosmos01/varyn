...
<html lang="en">
<head>
    <title>Varyn Games | Support</title>
    <meta name="title" content="Varyn Games Support" />
...
<div id="page_container">
    ...
    <div id="top_promo">
        <h2>Support</h2>
        <p>If you require support this is the place. What can we help you with?</p>
        <p>For fast response to common questions, did you check our <a href="/services/FAQ.php">FAQ</a>?</p>
        <p>Lost account</p>
        <p>Forgot Password</p>
        <p>Issues with games?</p>
        <p>Report annoying users</p>
        <p>Contact us</p>
    </div>
