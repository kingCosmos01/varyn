...
/** *** NOT THE REAL PROFILE PAGE - using this to test SSO sign up with Apple *****
        ...
        ?>
            ...
            <div class="row">
                <div class="col-md-6 profile-login">
                    ...
                    <form id="register_form" method="POST" action="/profile/" onsubmit="return <?php if ($isLoggedIn) {
                                                                                                    echo ('profilePage.updateFormValidation()');
                                                                                                } else {
                                                                                                    echo ('profilePage.registerFormValidation()');
                                                                                                } ?>;">
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane fade in active" id="basicInfo">
                                ...
                                ?>
                                    ...
                                    <div class="register-login-option">Already a member? <a href="/profile/" title="Already a member? Log in with your account" alt="Already a member? Log in with your account.">Log in</a>.</div>
                                <?php
                                }
                                ?>
                                ...
                                if (!$isLoggedIn) {
                                ?>
                                    <div class="form-group"><label for="register_form_password">Password: <span class="required-field">*</span></label><input type="password" name="register_form_password" class="popup-form-input required password" id="register_form_password" placeholder="A secure password" autocomplete="current-password" autocorrect="off" required maxlength="20" value="<?php echo ($password); ?>" />
                                        <div id="optional-small-label" class="checkbox optional-small"><label for="ShowPassword" onclick="profilePage.onClickShowPassword();"><input type="checkbox" name="register_form_showpassword" id="register_form_showpassword" onclick="profilePage.onClickShowPassword();"> <span id="register_form_showpassword_label">Show</span> <span id="register_form_showpassword_icon" class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></label></div>
                                    </div>
                                <?php
                                }
                                ?>
