    ...
    <div id="promos_middle">
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1070" title="Play Closest To The Pin on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/closestToThePin/images/128x75.jpg" border="0" width="128" height="75" alt="Play Closest To The Pin on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1075" title="Play Border Security on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/borderSecurity/images/128x75.jpg" border="0" width="128" height="75" alt="Play Border Security on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1000" title="Play Zam BeeZee on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/zamBeeZeeOnline/images/128x75.jpg" border="0" width="128" height="75" alt="Play Zam BeeZee on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1042" title="Play Skywords on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/skywords/images/128x75.jpg" border="0" width="128" height="75" alt="Play Skywords on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1046" title="Play Microbe Muncher on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/microbeMuncher/images/128x75.jpg" border="0" width="128" height="75" alt="Play Microbe Muncher on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1002" title="Play Mah Jongg Classic on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/mahJonggClassic/images/128x75.jpg" border="0" width="128" height="75" alt="Play Mah Jongg Classic on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1071" title="Play Air Wolf on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/airwolf/images/128x75.jpg" border="0" width="128" height="75" alt="Play Air Wolf on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1049" title="Play Air Traffic Chief on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/airTrafficChief/images/128x75.jpg" border="0" width="128" height="75" alt="Play Air Traffic Chief on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1067" title="Play Run Batman Run! on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/jumpChase/images/128x75.jpg" border="0" width="128" height="75" alt="Play Run Batman Run! on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1065" title="Play Rally Driver on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/carChase/images/128x75.jpg" border="0" width="128" height="75" alt="Play Rally Driver on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1066" title="Play Leap of the Ninja on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/leapOfTheNinja/images/128x75.jpg" border="0" width="128" height="75" alt="Play Leap of the Ninja on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1073" title="Play Volcano! on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/volcano/images/128x75.jpg" border="0" width="128" height="75" alt="Play Volcano! on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1074" title="Play Sudoku on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/sudoku/images/128x75.jpg" border="0" width="128" height="75" alt="Play Sudoku on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1006" title="Play Block Drop on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/blockDrop/images/128x75.jpg" border="0" width="128" height="75" alt="Play Block Drop on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1005" title="Play Missile Defense on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/missileDefense/images/128x75.jpg" border="0" width="128" height="75" alt="Play Missile Defense on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1016" title="Play Gem Craft on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/gemcraft/images/128x75.jpg" border="0" width="128" height="75" alt="Play Gem Craft on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1023" title="Play Street Fighter II: Champion Edition on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/streetFighterIIChampionEdition/images/128x75.jpg" border="0" width="128" height="75" alt="Play Street Fighter II: Champion Edition on Varyn now" /></a>
        ...
        <div class="games_promo">
            ...
            <div class="game_tab_middle">
                <a href="/play/?game_id=1047" title="Play Morningstar on Varyn now"><img class="game_tab_img" src="<?php echo($server);?>/games/morningstar/images/128x75.jpg" border="0" width="128" height="75" alt="Play Morningstar on Varyn now" /></a>
