...
class MarkdownEnginesis extends \Michelf\Markdown {
    ...
    /**
     * Find ~text~ or +text+ and convert to <del> or <ins>
     * @param $text
     * @return mixed
     */
    protected function doInsDel($text) {
        return $text;
    }

    /**
     * Callback for processing ins or del
     * @param  array $matches
     * @return string
     */
    protected function _doInsDel_callback($matches) {
        return $matches[0];
    }

    /**
     * Find ^text^ or $text$ and convert to <span> with larger or smaller font-size
     * @param $text
     * @return mixed
     */
    protected function doFontSpan($text) {
        return $text;
    }

    /**
     * Callback for processing font size span
     * @param  array $matches
     * @return string
     */
    protected function _doFontSpan_callback($matches) {
        return $matches[0];
    }
