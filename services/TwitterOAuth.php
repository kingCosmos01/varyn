<?php
    ...
    require_once ('TwitterOAuthException.php');
    require_once ('TwitterOAuthConsumer.php');
    require_once ('TwitterOAuthRequest.php');
    require_once ('TwitterOAuthResponse.php');
    require_once ('TwitterOAuthToken.php');
    ...
    class TwitterOAuth
    {
        ...
        const API_AUTHORIZE = 'oauth/authorize';
        const API_AUTHENTICATE = 'oauth/authenticate';
        const API_VERIFY_CREDENTIALS = 'account/verify_credentials';
        ...
        public function __construct($consumerKey, $consumerSecret, $oauthToken = null, $oauthTokenSecret = null)
        {
            ...
            $this->consumer = new TwitterOAuthConsumer($consumerKey, $consumerSecret);
            if (!empty($oauthToken) && !empty($oauthTokenSecret)) {
                $this->token = new TwitterOAuthToken($oauthToken, $oauthTokenSecret);
            }
            if (empty($oauthToken) && !empty($oauthTokenSecret)) {
        ...
        {
            $this->response = new TwitterOAuthResponse();
        }
        ...
        public function oauth2($path, array $parameters = [])
        {
            ...
            $this->response->setApiPath($path);
            $url = sprintf('%s/%s', self::API_HOST, $path);
            $request = TwitterOAuthRequest::fromConsumerAndToken($this->consumer, $this->token, $method, $url, $parameters);
        ...
        /**
         * Request the Twitter oauth request token. When granted this is later used to get an access token.
         * @param array $parameters
         * @return array
         * @throws TwitterOAuthException
         */
        ...
        {
            return $this->oauth(self::API_REQUEST_TOKEN, $parameters);
        }
        ...
        {
            return $this->oauth(self::API_ACCESS_TOKEN, $parameters);
        }
        ...
        public function getUser(array $parameters = [])
        {
            ...
            return $this->get(self::API_VERIFY_CREDENTIALS, $parameters);
        }
        ...
        private function request($url, $method, $authorization, array $postfields)
        {
            ...
            switch ($method) {
                ...
                case 'POST':
                    ...
                    $options[CURLOPT_POSTFIELDS] = TwitterOAuthRequest::buildHttpQuery($postfields);
                    break;
                case 'DELETE':
            ...
            if (in_array($method, ['GET', 'PUT', 'DELETE']) && !empty($postfields)) {
                $options[CURLOPT_URL] .= '?' . TwitterOAuthRequest::buildHttpQuery($postfields);
            }
         ...
         * @return string
         */
        private function encodeAppAuthorization(TwitterOAuthConsumer $consumer)
        {
